...
public class Radians {
    ...
    public static void main(String[] args) {
        ...
        double mathToRad = Math.toRadians(degrees);
        System.out.println("The Math.toRadians method produced: " + mathToRad);
        ...
        double mathToDeg = Math.toDegrees(radians);
        System.out.println("The Math.toDegrees method produced: " + mathToDeg);
    }
}